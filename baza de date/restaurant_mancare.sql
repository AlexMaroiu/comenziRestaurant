...
LOCK TABLES `mancare` WRITE;
/*!40000 ALTER TABLE `mancare` DISABLE KEYS */;
INSERT INTO `mancare` VALUES ('snitel',15.00,1,'pui, pesmet, ou','snitel'),('cartofi prajiti',7.00,2,'cartofi','cp');
/*!40000 ALTER TABLE `mancare` ENABLE KEYS */;
UNLOCK TABLES;
